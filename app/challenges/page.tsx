        ...
        <main className="mx-auto max-w-7xl p-4">
          ...
          {user && (
            <motion.div
              ...
              className="mb-8 rounded-lg border border-blue-900/50 bg-black/50 p-6 backdrop-blur-sm"
            >
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                  <h2 className="text-2xl font-bold text-blue-400">Detective Status</h2>
                  <p className="text-gray-400">
                    Current Rank: <span className="text-white">{user.rank}</span>
                  </p>
                  <p className="text-gray-400">
                    Points: <span className="text-white">{user.totalPoints}</span>
                  </p>
                </div>
                <div className="w-full md:w-1/2">
                  <p className="mb-2 text-sm text-gray-400">Investigation Progress</p>
                  ...
                  <p className="mt-1 text-right text-xs text-gray-400">{calculateProgress()}% Complete</p>
                </div>
              </div>
            </motion.div>
          )}
